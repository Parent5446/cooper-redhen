...
\begin{DoxyCompactList}\small\item\em Provide functions for identifying a spectrum for an unknown substance using various methods of database searching. \item\end{DoxyCompactList}\end{DoxyCompactItemize}
